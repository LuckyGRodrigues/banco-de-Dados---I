import HistoricoComprasModel from '../models/HistoricoComprasModel';
...
const get = async (req, res) => {
  try {
    ...
    if (!id) {
      const response = await HistoricoComprasModel.findAll({
        order: [['id', 'asc']],
      });
    ...
    const response = await HistoricoComprasModel.findOne({
      where: {
        id,
      },
    });
